...
```
cd existing_repo
git remote add origin https://gitlab.polytech.umontpellier.fr/rasim.erben/projet-jeu.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.polytech.umontpellier.fr/rasim.erben/projet-jeu/-/settings/integrations)
